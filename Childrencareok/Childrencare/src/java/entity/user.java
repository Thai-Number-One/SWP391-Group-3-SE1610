...
public class user {
    ...
    public user(int id, String fullName, String address, String phone, String email, Date date, String userName, String password, String avatar, int gender, int role, int status) {
        this.id = id;
