            ...
            <div class="card-body p-3">
              <div class="row">
                  ...
                  <div class="numbers">
                    ...
                    <p class="text-success font-weight-bolder">Success: 2000</p>
                    <p class="text-danger font-weight-bolder">Canceled: 100</p>
                    <p class=" font-weight-bolder">Submitted: 200</p>
            ...
            <div class="card-body p-3">
              <div class="row">
                  ...
                  <div class="numbers">
                    ...
                    <p class=" font-weight-bolder">New Registered: 2000</p>
                    <p class=" font-weight-bolder">New Reserved: 100</p>
            ...
            <div class="card-body p-3">
              <div class="row">
                  ...
                  <div class="numbers">
                    ...
                    <p class=" font-weight-bolder">Average star: 100</p>
                  </div>
                ...
                <tbody>
                  <tr>
                    ...
                    <td>
                      <div class="text-center">
                        <h1 class="text-sm mb-0">Total Amount:</h1>
                        
                      </div>
                    </td>
                    <td>
                      <div class="text-center">
                        <h1 class="text-sm mb-0">Ballance:</h1>
                      </div>
                    </td>
                  ...
                  <tr>
                    <td class="w-30">
                      <div class="d-flex px-2 py-1 align-items-center">
                        <div class="ms-4">
                          <h1 class="text-sm mb-0 text-uppercase font-weight-bold">.name</h1>
                        </div>
                      </div>
                    </td>
                    <td>
                    ...
                    <td>
                      <div class="text-center">
                        ...
                        <h6 class="text-sm mb-0">.ballace</h6>
                      </div>
                    </td>
                    <td class="align-middle text-sm">
                      <div class="col text-center">
