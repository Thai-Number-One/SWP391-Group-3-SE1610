                                ...
                                <table class="table align-items-center justify-content-center mb-0">
                                    <thead>
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" value="Nguyen Van A" class="form-control" name="id" readonly required>
                                            </td>
                                        </tr>
                                        <tr>
                                            <th class="text-uppercase text-secondary text-xx font-weight-bolder opacity-50 ps-2 ">Email</th>
                                            <td>
                                                <input type="text" value="ABC@Gmail.com" class="form-control" name="id" readonly required>
                                            </td>
                                            <span class="glyphicon glyphicon-eye-open"></span>                                            
                                        </tr>
                                        <tr>
                                            <th class="text-uppercase text-secondary text-xx font-weight-bolder opacity-50 ps-2">Moblie</th>
                                            <td>
                                                <input type="text" value="0987654321" class="form-control" name="value" readonly required>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td class="align-middle text-sm mb-0">
                                                <input type="text" value="Kham rang" class="form-control" name="value" readonly required>
                                            </td>
                                        </tr>
                                        <tr>
