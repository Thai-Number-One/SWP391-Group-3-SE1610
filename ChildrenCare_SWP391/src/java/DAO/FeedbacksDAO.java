...
public class FeedbacksDAO extends BaseDAO{
     ...
     public void updateStatusFeedback(int id,String s) throws Exception{
        try {
     ...
     public List<Feedbacks> feedbacks() throws Exception {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                s.setStatus(rs.getString("Feedback_status"));
...
"					inner join Service as e on c.Service_ID=e.Service_ID";
        try {
            ...
            while (rs.next()) {
                ...
                f.setStatus(rs.getString("Feedback_status"));
     ...
     public static void main(String[] args) {
         try {
             ...
             for (int i = 0; i < f.allfeedbacks().size(); i++) {
                 System.out.println(f.allfeedbacks().get(i).getFeedbacks().getDetail());
             }
         } catch (Exception ex) {
